...
> **Fecha:** 2026-07-22  ·  **Integridad:** ✅  ·  **Horizonte:** 2015-2026  ·  **global:** 204 filas  ·  **gen:** 612 filas

Algoritmos en competición: base (media, naive, deriva, lineal, ETS, ARIMA) + avanzados (Prophet, RandomForest, XGBoost=sí). Selección por MAPE con regla de parsimonia (el modelo más simple dentro del 15% del mejor MAPE; escalado a avanzados solo si el mejor base supera 10% de MAPE).
...
**95% de las series se proyectan con estimadores simples** (complejidad ≤ 1). Solo 107 series escalaron a evaluar modelos avanzados. Prophet no fue seleccionado en ninguna serie: para series anuales cortas los modelos parsimoniosos igualan o superan a los complejos.
...
| `gasto_edu_pib` | 170 | 34 | 16.7% | 5.8% | 0.23 |
...
| `gasto_edu_pib` | 4.0653 %PIB | `naive` |
